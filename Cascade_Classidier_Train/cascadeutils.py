...
# reads all the files in the /notCarWheels folder and generates neg.txt from them.
# we'll run it manually like this:
# $ python
# Python 3.8.0 (tags/v3.8.0:fa919fd, Oct 14 2019, 19:21:23) [MSC v.1916 32 bit (Intel)] on win32
# Type "help", "coyright", "credits" or "license" for more information.
...
def generate_negative_description_file():
    ...
    with open('neg.txt', 'w') as f:
        ...
        for filename in os.listdir('notCarWheel'):
            f.write('notCarWheel/' + filename + '\n')

# the opencv_annotation executable can be found in opencv/build/x64/vc15/bin
# generate carwheel description file using:
# $ C:/Users/David/Documents/Universtity/opencv/build/x64/vc15/bin/opencv_annotation.exe --annotations=pos.txt --images=carwheel/
...
# generate carwheel samples from the annotations to get a vector file using:
# $ C:/Users/David/Documents/Universtity/opencv/build/x64/vc15/bin/opencv_createsamples.exe -info pos.txt -w 24 -h 24 -num 1000 -vec pos.vec
...
## MY CODE: C:/Users/David/Documents/Universtity/opencv/build/x64/vc15/bin/opencv_traincascade.exe -data model/ -vec pos.vec -bg neg.txt -numPos 450 -numNeg 1280 -acceptanceRatioBreakValue 10e-5 -w 24 -h 24 -maxFalseAlarmRate 0.01 -minHitRate 0.97
